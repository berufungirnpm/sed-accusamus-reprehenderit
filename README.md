...
```sh
$ npm install @berufungirnpm/sed-accusamus-reprehenderit
```
...
```javascript
import converter from "@berufungirnpm/sed-accusamus-reprehenderit";
```

## Usage in Node.js(CommonJS):

```javascript
const {converter} = require("@berufungirnpm/sed-accusamus-reprehenderit");
```
...
```html
<script src="/node_modules/@berufungirnpm/sed-accusamus-reprehenderit/build/umd/index.js"></script>
```
This exposes the program on the window object:
```javascript
const javascriptBinaryConverter = window['@berufungirnpm/sed-accusamus-reprehenderit']
...
```javascript
   ...
   const {HexStringConverter} = require('@berufungirnpm/sed-accusamus-reprehenderit');
...
#### Binary to integer
 ```javascript
   const {BinaryConverter} = require('@berufungirnpm/sed-accusamus-reprehenderit');
